...
class GetData:
    ...
    def __init__(self, endpoint: str, headers: object) -> object:
        """
    ...
    def get_users_top_items(self, filename: str, limit: int = 25, offset: int = 0, type: str = 'tracks', time_range: str = 'medium_term') -> object:
