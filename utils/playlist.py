...
class Playlist:
    ...
    def create_playlist(self, name: str, description: str, public: bool = False):
        ...
        """
        endpoint_url = f'{self.__endpoint}users/{self.__user_id}/playlists'
        ...
        response = requests.post(url=endpoint_url, data=request_body, headers=self.__headers)
    ...
    def populate_playlist(self, uris: list, playlist_id: str) -> None:
        ...
        """
        endpoint_url = f'{self.__endpoint}playlists/{playlist_id}/tracks'
